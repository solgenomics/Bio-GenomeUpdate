...
#
# To run, this script requires create_pseudo_gff_from_vcf.pl
#                      split_by_lines.sh
...
./copy_updated_coordinates_to_vcf.pl temp_update_files/$file.$NEW_CHROM_LABEL $file $NEW_CHROM_LABEL; 
